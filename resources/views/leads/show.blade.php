    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="sidebarheader">
                <p> {{ __('Information sur le rendez-vous') }}</p>
            </div>
            ...
            @if($lead->status == 1)
               ...
               'method' => 'PATCH',
                ...
                {!! Form::submit(__('Assigner un nouvel utilisateur'), ['class' => 'btn btn-primary form-control closebtn']) !!}
                {!! Form::close() !!}
                {!! Form::model($lead, [
               'method' => 'PATCH',
               'url' => ['leads/updatestatus', $lead->id],
                ...
                {!! Form::submit(__('Fermer le Rendez-vous'), ['class' => 'btn btn-success form-control closebtn movedown']) !!}
                {!! Form::close() !!}
            @endif
