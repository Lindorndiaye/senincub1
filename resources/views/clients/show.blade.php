...
@endpush
    ...
    <div class="row">
        <div class="col-md-8 currenttask">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#task">{{__('Tâche')}}</a></li>
                <li><a data-toggle="tab" href="#lead">{{__('Rendez-Vous')}}</a></li>
                <li><a data-toggle="tab" href="#document">{{__('Documents')}}</a></li>
                {{-- <li><a data-toggle="tab" href="#invoice">{{__('Factures')}}</a></li> --}}
    ...
    <div class="col-md-4 currenttask">
               ...
               'method' => 'PATCH',
                ...
                {!! Form::submit(__('Attribuer un nouvel utilisateur'), ['class' => 'btn btn-primary form-control closebtn']) !!}
                {!! Form::close() !!}
    </div>
    </div>
    </div>
