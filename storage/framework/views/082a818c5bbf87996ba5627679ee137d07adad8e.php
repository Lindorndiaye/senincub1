    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="sidebarheader">
                <p> <?php echo e(__('Lead information')); ?></p>
            </div>
            ...
            <?php if($lead->status == 1): ?>
               ...
               'method' => 'PATCH',
                ...
                <?php echo Form::submit(__('Assign new user'), ['class' => 'btn btn-primary form-control closebtn']); ?>
               ...
               'url' => ['leads/updatestatus', $lead->id],
                ...
                <?php echo Form::submit(__('Complete Lead'), ['class' => 'btn btn-success form-control closebtn movedown']); ?>
