...
<div class="col-sm-6">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h4 class="box-title"
            >
                <?php echo e(__('Tâches de ce mois')); ?>
        ...
        <div id="collapseOne" class="panel-collapse">
            <div class="box-body">
                <div>
                    <graphline class="chart" :labels="<?php echo e(json_encode($createdTaskEachMonths)); ?>"
                               :values="<?php echo e(json_encode($taskCreated)); ?>"
                               :valuesextra="<?php echo e(json_encode($taskCompleted)); ?>"></graphline>
                </div>
            </div>
        </div>
    </div>
    <div class="box box-primary">
        <div class="box-header with-border">
            <h4 class="box-title"
            >
               <?php echo e(__('Rendez-vous ce mois')); ?>
        ...
        <div id="collapseTwo" class="panel-collapse">
            <div class="box-body">
                <div>
                    <graphline class="chart" :labels="<?php echo e(json_encode($createdLeadEachMonths)); ?>"
                               :values="<?php echo e(json_encode($leadCreated)); ?>"
                               :valuesextra="<?php echo e(json_encode($leadsCompleted)); ?>"></graphline>
